...
function Footer() {
  return (
    <div style={{width:'100%',height:'250px',backgroundColor:"grey"}} className=' d-flex flex-column justify-content-center align-items-center text-white'>
      ...
      <p className='text-secondary'>Copyright © 202 Tee-shirt-store. Built with React.</p>
    </div>
  )
}
